...
import ErrorPage from "./Pages/Error"; // Importation de la page d'erreur
import Footer from "./Components/Footer"; // Importation du composant Footer
import Header from "./Components/Header"; // Importation du composant Header
import Accomodation from "./Pages/Accomodation"; // Importation de la page de détails du logement
